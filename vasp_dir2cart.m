function [B,Ap,a,N,T,id,crystal,sel_dyn, dyn_tag] = vasp_dir2cart(filename, new_filename)
...
if crystal == 1
    Ac = B*Ap;
    vasp_write_poscar(B,Ac,a,N,id,0,sel_dyn,dyn_tag,new_filename);
else 
    disp('Coordinates are already in cartesian coordinates')
end
